...
from core.models import HealingObject, HealthObjectType
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print "Importing closed statuses..."
        reader = csv.reader(csvfile, delimiter=';')
    ...
    def import_mu_data(self, reader, encoding):
        ...
        for row in reader:
            ...
            if not (mu is None):
                ...
                mu.closing_reason = row[header["Prichina_CLOSE"]].decode(encoding).strip()

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LegalEntity', fields ['name']
        db.create_unique(u'core_legalentity', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'LegalEntity', fields ['name']
        db.delete_unique(u'core_legalentity', ['name'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_legalentity', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'LegalEntity.name'
        db.alter_column(u'core_legalentity', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

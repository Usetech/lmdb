...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AddressObject.building'
        db.alter_column(u'core_addressobject', 'building', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'AddressObject.house'
        db.alter_column(u'core_addressobject', 'house', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'AddressObject.housing'
        db.alter_column(u'core_addressobject', 'housing', self.gf('django.db.models.fields.CharField')(max_length=2))

    models = {
        u'core.addressobject': {
            'Meta': {'object_name': 'AddressObject'},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'building': ('django.db.models.fields.CharField', [], {'max_length': '8', 'blank': 'True'}),
            ...
            'house': ('django.db.models.fields.CharField', [], {'max_length': '8', 'blank': 'True'}),
            'house_letter': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
            'housing': ('django.db.models.fields.CharField', [], {'max_length': '8', 'blank': 'True'}),

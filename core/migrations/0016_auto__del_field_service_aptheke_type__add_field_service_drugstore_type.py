...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.aptheke_type'
        db.delete_column(u'core_service', 'aptheke_type')

        # Adding field 'Service.drugstore_type'
        db.add_column(u'core_service', 'drugstore_type',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.hospital_type'
        db.add_column(u'core_service', 'hospital_type',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Service.aptheke_type'
        db.add_column(u'core_service', 'aptheke_type',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Service.drugstore_type'
        db.delete_column(u'core_service', 'drugstore_type')

        # Deleting field 'Service.hospital_type'
        db.delete_column(u'core_service', 'hospital_type')

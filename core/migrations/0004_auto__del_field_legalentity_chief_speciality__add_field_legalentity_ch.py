...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LegalEntity.chief_speciality'
        db.delete_column(u'core_legalentity', 'chief_speciality_id')

        # Adding field 'LegalEntity.chief_original_name'
        db.add_column(u'core_legalentity', 'chief_original_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LegalEntity.chief_position'
        db.add_column(u'core_legalentity', 'chief_position',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Position'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'LegalEntity.original_address'
        db.add_column(u'core_legalentity', 'original_address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HealingObject.original_address'
        db.add_column(u'core_healingobject', 'original_address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Service.chief_speciality'
        db.delete_column(u'core_service', 'chief_speciality_id')

        # Adding field 'Service.chief_original_name'
        db.add_column(u'core_service', 'chief_original_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.chief_position'
        db.add_column(u'core_service', 'chief_position',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Position'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LegalEntity.chief_speciality'
        db.add_column(u'core_legalentity', 'chief_speciality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Position'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LegalEntity.chief_original_name'
        db.delete_column(u'core_legalentity', 'chief_original_name')

        # Deleting field 'LegalEntity.chief_position'
        db.delete_column(u'core_legalentity', 'chief_position_id')

        # Deleting field 'LegalEntity.original_address'
        db.delete_column(u'core_legalentity', 'original_address')

        # Deleting field 'HealingObject.original_address'
        db.delete_column(u'core_healingobject', 'original_address')

        # Adding field 'Service.chief_speciality'
        db.add_column(u'core_service', 'chief_speciality',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Position'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Service.chief_original_name'
        db.delete_column(u'core_service', 'chief_original_name')

        # Deleting field 'Service.chief_position'
        db.delete_column(u'core_service', 'chief_position_id')

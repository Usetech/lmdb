...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.drug_provisioning'
        db.alter_column(u'core_service', 'drug_provisioning', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Service.specialization'
        db.alter_column(u'core_service', 'specialization', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Service.receipes_provisioning'
        db.alter_column(u'core_service', 'receipes_provisioning', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
        ...
        # Changing field 'Service.hospital_levels'
        db.alter_column(u'core_service', 'hospital_levels', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Service.departments'
        db.alter_column(u'core_service', 'departments', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Service.tour'
        db.alter_column(u'core_service', 'tour', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Service.free_services'
        db.alter_column(u'core_service', 'free_services', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Service.drug_provisioning'
        db.alter_column(u'core_service', 'drug_provisioning', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.specialization'
        db.alter_column(u'core_service', 'specialization', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.receipes_provisioning'
        db.alter_column(u'core_service', 'receipes_provisioning', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.paid_services'
        db.alter_column(u'core_service', 'paid_services', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.hospital_levels'
        db.alter_column(u'core_service', 'hospital_levels', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.departments'
        db.alter_column(u'core_service', 'departments', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.tour'
        db.alter_column(u'core_service', 'tour', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.free_services'
        db.alter_column(u'core_service', 'free_services', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    models = {
        ...
        u'core.healingobject': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.AddressObject']", 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'core.service': {
            ...
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'departments': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            ...
            'free_services': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),

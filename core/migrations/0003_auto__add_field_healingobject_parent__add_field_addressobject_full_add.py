...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealingObject.parent'
        db.add_column(u'core_healingobject', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='branches', null=True, to=orm['core.HealingObject']),
                      keep_default=False)

        # Adding field 'AddressObject.full_address_string'
        db.add_column(u'core_addressobject', 'full_address_string',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealingObject.parent'
        db.delete_column(u'core_healingobject', 'parent_id')

        # Deleting field 'AddressObject.full_address_string'
        db.delete_column(u'core_addressobject', 'full_address_string')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.workhours_clarification'
        db.add_column(u'core_service', 'workhours_clarification',
                      self.gf('django.db.models.fields.CharField')(max_length=3000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.workhours_clarification'
        db.delete_column(u'core_service', 'workhours_clarification')

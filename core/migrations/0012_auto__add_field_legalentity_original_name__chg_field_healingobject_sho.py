...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LegalEntity.original_name'
        db.add_column(u'core_legalentity', 'original_name',
    ...
    def backwards(self, orm):
        # Deleting field 'LegalEntity.original_name'
        db.delete_column(u'core_legalentity', 'original_name')


        # Changing field 'HealingObject.short_name'
        db.alter_column(u'core_healingobject', 'short_name', self.gf('django.db.models.fields.CharField')(default='', max_length=1024))

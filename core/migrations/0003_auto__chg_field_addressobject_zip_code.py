...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AddressObject.zip_code'
        db.alter_column(u'core_addressobject', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'AddressObject.zip_code'
        db.alter_column(u'core_addressobject', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=6))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_legalentity', 'inn_code', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Changing field 'LegalEntity.chief_sex'
        db.alter_column(u'core_legalentity', 'chief_sex', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Changing field 'LegalEntity.chief_last_name'
        db.alter_column(u'core_legalentity', 'chief_last_name', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Changing field 'LegalEntity.name'
        db.alter_column(u'core_legalentity', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=2000))

        # Changing field 'LegalEntity.chief_phone'
        db.alter_column(u'core_legalentity', 'chief_phone', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Changing field 'LegalEntity.chief_first_name'
        db.alter_column(u'core_legalentity', 'chief_first_name', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))
        ...
        # Changing field 'Service.chief_sex'
        db.alter_column(u'core_service', 'chief_sex', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LegalEntity.chief_sex'
        db.alter_column(u'core_legalentity', 'chief_sex', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'LegalEntity.chief_last_name'
        db.alter_column(u'core_legalentity', 'chief_last_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'LegalEntity.name'
        db.alter_column(u'core_legalentity', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))

        # Changing field 'LegalEntity.chief_phone'
        db.alter_column(u'core_legalentity', 'chief_phone', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'LegalEntity.chief_first_name'
        db.alter_column(u'core_legalentity', 'chief_first_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
        ...
        # Changing field 'Service.chief_sex'
        db.alter_column(u'core_service', 'chief_sex', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

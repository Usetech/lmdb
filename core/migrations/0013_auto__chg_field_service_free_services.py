...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_service', 'free_services', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))
    ...
    models = {
        ...
        u'core.service': {
            ...
            'free_services': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),

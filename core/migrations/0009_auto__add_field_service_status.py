...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.status'
        db.add_column(u'core_service', 'status',
                      self.gf('django.db.models.fields.CharField')(default='\xd0\x90', max_length=5, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.status'
        db.delete_column(u'core_service', 'status')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LegalEntity.status'
        db.add_column(u'core_legalentity', 'status',
                      self.gf('django.db.models.fields.CharField')(default='OK', max_length=5, db_index=True),
                      keep_default=False)

        # Adding field 'HealingObject.status'
        db.add_column(u'core_healingobject', 'status',
                      self.gf('django.db.models.fields.CharField')(default='OK', max_length=5, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LegalEntity.status'
        db.delete_column(u'core_legalentity', 'status')

        # Deleting field 'HealingObject.status'
        db.delete_column(u'core_healingobject', 'status')

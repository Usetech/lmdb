...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceType.code'
        db.add_column(u'core_servicetype', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Position.code'
        db.add_column(u'core_position', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True),
                      keep_default=False)

        # Adding field 'HealthObjectType.code'
        db.add_column(u'core_healthobjecttype', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceType.code'
        db.delete_column(u'core_servicetype', 'code')

        # Deleting field 'Position.code'
        db.delete_column(u'core_position', 'code')

        # Deleting field 'HealthObjectType.code'
        db.delete_column(u'core_healthobjecttype', 'code')

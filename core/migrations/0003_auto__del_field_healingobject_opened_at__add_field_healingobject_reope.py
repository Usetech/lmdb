...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HealingObject.reopened_at'
        db.add_column(u'core_healingobject', 'reopened_at',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'HealingObject.closed_at'
        db.alter_column(u'core_healingobject', 'closed_at', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HealingObject.reopened_at'
        db.delete_column(u'core_healingobject', 'reopened_at')


        # Changing field 'HealingObject.closed_at'
        db.alter_column(u'core_healingobject', 'closed_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AddressObject.building'
        db.alter_column(u'core_addressobject', 'building', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'AddressObject.house'
        db.alter_column(u'core_addressobject', 'house', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'AddressObject.house_letter'
        db.alter_column(u'core_addressobject', 'house_letter', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'AddressObject.housing'
        db.alter_column(u'core_addressobject', 'housing', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'AddressObject.building'
        db.alter_column(u'core_addressobject', 'building', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'AddressObject.house'
        db.alter_column(u'core_addressobject', 'house', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'AddressObject.house_letter'
        db.alter_column(u'core_addressobject', 'house_letter', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'AddressObject.housing'
        db.alter_column(u'core_addressobject', 'housing', self.gf('django.db.models.fields.CharField')(max_length=8))

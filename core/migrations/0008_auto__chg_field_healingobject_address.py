...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HealingObject.address'
        db.alter_column(u'core_healingobject', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AddressObject'], null=True))

    def backwards(self, orm):

        # Changing field 'HealingObject.address'
        db.alter_column(u'core_healingobject', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=u'', to=orm['core.AddressObject']))

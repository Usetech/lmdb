...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LegalEntity.jur_address'
        db.alter_column(u'core_legalentity', 'jur_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.AddressObject']))

    def backwards(self, orm):

        # Changing field 'LegalEntity.jur_address'
        db.alter_column(u'core_legalentity', 'jur_address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=u'', to=orm['core.AddressObject']))

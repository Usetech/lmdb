...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StreetObject.iname'
        db.add_column(u'core_streetobject', 'iname',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=256),
                      keep_default=False)

        # Adding field 'LegalEntity.errors'
        db.add_column(u'core_legalentity', 'errors',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HealingObject.errors'
        db.add_column(u'core_healingobject', 'errors',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding index on 'AddressObject', fields ['bsi_id']
        db.create_index(u'core_addressobject', ['bsi_id'])


    def backwards(self, orm):
        # Removing index on 'AddressObject', fields ['bsi_id']
        db.delete_index(u'core_addressobject', ['bsi_id'])

        # Deleting field 'StreetObject.iname'
        db.delete_column(u'core_streetobject', 'iname')

        # Deleting field 'LegalEntity.errors'
        db.delete_column(u'core_legalentity', 'errors')

        # Deleting field 'HealingObject.errors'
        db.delete_column(u'core_healingobject', 'errors')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClosingReason'
        db.create_table(u'core_closingreason', (
        ...
        db.send_create_signal(u'core', ['ClosingReason'])
        ...
        db.alter_column(u'core_healingobject', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Renaming column for 'HealingObject.closing_reason' to match new field type.
        db.rename_column(u'core_healingobject', 'closing_reason', 'closing_reason_id')
        # Changing field 'HealingObject.closing_reason'
        db.alter_column(u'core_healingobject', 'closing_reason_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.ClosingReason']))
        # Adding index on 'HealingObject', fields ['closing_reason']
        db.create_index(u'core_healingobject', ['closing_reason_id'])


        # Changing field 'HealingObject.full_name'
        db.alter_column(u'core_healingobject', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):
        # Removing index on 'HealingObject', fields ['closing_reason']
        db.delete_index(u'core_healingobject', ['closing_reason_id'])

        # Deleting model 'ClosingReason'
        db.delete_table(u'core_closingreason')
        ...
        # Renaming column for 'HealingObject.closing_reason' to match new field type.
        db.rename_column(u'core_healingobject', 'closing_reason_id', 'closing_reason')
        # Changing field 'HealingObject.closing_reason'
        db.alter_column(u'core_healingobject', 'closing_reason', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

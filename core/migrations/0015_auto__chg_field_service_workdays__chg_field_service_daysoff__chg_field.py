...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.workdays'
        db.alter_column(u'core_service', 'workdays', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Service.daysoff'
        db.alter_column(u'core_service', 'daysoff', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Service.daysoff_restrictions'
        db.alter_column(u'core_service', 'daysoff_restrictions', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Service.workhours'
        db.alter_column(u'core_service', 'workhours', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Service.workdays'
        db.alter_column(u'core_service', 'workdays', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Service.daysoff'
        db.alter_column(u'core_service', 'daysoff', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Service.daysoff_restrictions'
        db.alter_column(u'core_service', 'daysoff_restrictions', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Service.workhours'
        db.alter_column(u'core_service', 'workhours', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

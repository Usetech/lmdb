...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LegalEntity.manager_user'
        db.add_column(u'core_legalentity', 'manager_user',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HealingObject.manager_user'
        db.add_column(u'core_healingobject', 'manager_user',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LegalEntity.manager_user'
        db.delete_column(u'core_legalentity', 'manager_user')

        # Deleting field 'HealingObject.manager_user'
        db.delete_column(u'core_healingobject', 'manager_user')

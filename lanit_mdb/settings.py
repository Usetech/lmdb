...
#        'NAME': 'lanitmdb.db',                      # Or path to database file if using sqlite3.
...
#    }
    'default': {
        ...
        'NAME': 'lanit',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'lanit',
        'PASSWORD': 'tanil',
...
SECRET_KEY = 'ycraj#31gcsau=h3n&qo0@9z%@7+4gi8s&9=dr&og9&*fcv=-0'
